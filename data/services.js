...
export const GIGS = [
    new Gigs ('G1','Alice Achieng','waumini Apartments, House 14', 'Plumber','Hello, am looking for a plumber to fix my kitchen sink,please look at the photos I sent. Its urgent please', ''),
    new Gigs ('G2','Merald Wanjiru','Fawe House, Apartment no. 4', 'Plumber', 'Hi, My bathtub shower broke, its pouring water allover my bathroom, I need a plumber right away.', '')
];
